      ...
      <section className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            <p>
              Verdant Impact website is owned by VERDANT IMPACT PRIVATE LIMITED,
              which is a data controller of your personal data.
            </p>
  
            <p>
              We have adopted this Privacy Policy, which determines how we are
              processing the information collected by Verdant Impact, which also
            ...
            <h2 className="text-2xl font-bold text-secondary mt-10">
              Personal information we collect:
            </h2>
  
            <p>
              When you visit the Verdant Impact, we automatically collect certain
            ...
            <p>
              ...
              organization, telephone number. You can choose not to provide us
              with your personal data, but then you may not be able to take
              advantage of some of the website’s features. For example, you won’t
              be able to receive our Newsletter or contact us directly from the
              website. Users who are uncertain about what information is mandatory
              are welcome to contact us via info@verdantimpact.com .
            </p>
